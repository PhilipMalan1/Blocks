...
namespace Blocks
{
    ...
    class FallingPlatform : GameObject
    {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spritebach, Vector2 camera)
        {
            ...
            spritebach.Draw(image, new Rectangle((int)(Pos.X - camera.X), (int)(Pos.Y - camera.Y), (int)BlockWidth*3, (int)((float)image.Height/image.Width*3*BlockWidth)), new Rectangle(0, 0, image.Width, image.Height), Color.White, 0, new Vector2(), SpriteEffects.None, (float)DrawLayer.FallingPlatform / 1000);
        }
